...
public class ScoreBoardMenu {
    ...
    private void addUsers(){
        ...
        request.setToken("");
        request.addData("method", "/getAllUsers");
        request.addData("args", new Object[]{});
        Response response = NetworkController.send(request);
        Vector<User> users = (Vector<User>) response.get("users");
        System.out.println("kaaaaarrrr");
        users.sort((o1, o2) -> {
    ...
    private void addLabels(User u, Pane p){
        ...
        if(u.getLastSeen() == null)
            userLastOnline.setText("Online");
        else
            userLastOnline.setText(u.getLastSeen().toString());
    ...
    private void addUserAvatar(User u, Pane p){
        ...
        circle.setRadius(25);
        circle.setFill(new ImagePattern(ImagesAddress.getImageByNameInEnum(u.getAvatarUrl()).getImage()));
