...
public class GameMenuController {
	...
	//SELECT:
	@GameCommand(command = Commands.SELECT_UNIT)
	...
	@GameCommand(command = Commands.SELECT_CITY)
	...
	//UNIT:
	@GameCommand(command = Commands.UNIT_MOVE)
	...
	@GameCommand(command = Commands.MAP_SHOW)
	...
	@GameCommand(command = Commands.MAP_MOVE)
	...
	@GameCommand(command = Commands.INCREASE_RESOURCE)
...
//		game.getCurrentPlayer().getCivilization().addUnit(unit);
	...
	@GameCommand(command = Commands.LIST_OF_PRODUCTIONS)
	...
	@GameCommand(command = Commands.LIST_OF_ALL_OF_PRODUCTIONS)
	...
	@GameCommand(command = Commands.PURCHASE_PRODUCTION)
	...
	@GameCommand(command = Commands.SET_PRODUCTION)
	...
	@GameCommand(command = Commands.GET_PURCHASABLE_TILES)
	...
	@GameCommand(command = Commands.PURCHASE_TILE)
	...
	@GameCommand(command = Commands.LIST_OF_POPULATION)
	...
	@GameCommand(command = Commands.SET_TILE_FOR_POPULATION)
	...
	@GameCommand(command = Commands.DELETE_POPULATION_FROM_TILE)
...
//			System.out.println("unit type " + unit.toString());
	...
	@GameCommand(command = Commands.TELEPORT)
	...
	@GameCommand(command = Commands.FOG_OF_WAR)
	...
	@GameCommand(command = Commands.ADD_HAPPINESS)
	...
	@GameCommand(command = Commands.CREATE_FEATURE)
	...
	@GameCommand(command = Commands.ADD_SCORE)
	...
	@GameCommand(command = Commands.NEXT_TURN)
	...
	@GameCommand(command = Commands.MULTI_NEXT_TURN)
	...
	@GameCommand(command = Commands.SHOW_PLAYER)
	...
	@GameCommand(command = Commands.DESTROY)
	...
	@GameCommand(command = Commands.SAVE)
