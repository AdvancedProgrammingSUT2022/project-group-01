...
public class InfoMenuController {
	...
	@GameCommand(command = Commands.ACTIVE_UNIT)
	...
	@GameCommand(command = Commands.SHOW_MILITARY_OVERVIEW)
	...
	@GameCommand(command = Commands.SHOW_CITY_SCREEN)
	...
	@GameCommand(command = Commands.SHOW_ECONOMIC_OVERVIEW)
