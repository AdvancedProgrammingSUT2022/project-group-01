...
public class ConsoleMap {
	...
	private void initializeCharRepresent() {
		...
		// Improvements
		charRepresentation.put(ImprovementType.MANUFACTORY, colorCharacter.BRIGHT_PINK.setTextColor("MA"));
		charRepresentation.put(ImprovementType.CAMP, colorCharacter.BRIGHT_PINK.setTextColor("CA"));
		charRepresentation.put(ImprovementType.TRADING_POST, colorCharacter.BRIGHT_PINK.setTextColor("TP"));
		charRepresentation.put(ImprovementType.QUARRY, colorCharacter.BRIGHT_PINK.setTextColor("QU"));
		charRepresentation.put(ImprovementType.PLANTATION, colorCharacter.BRIGHT_PINK.setTextColor("PL"));
		charRepresentation.put(ImprovementType.LUMBER_MILL, colorCharacter.BRIGHT_PINK.setTextColor("LM"));
		charRepresentation.put(ImprovementType.FARM, colorCharacter.BRIGHT_PINK.setTextColor("FA"));
		charRepresentation.put(ImprovementType.PASTURE, colorCharacter.BRIGHT_PINK.setTextColor("PA"));
		charRepresentation.put(ImprovementType.MINE, colorCharacter.BRIGHT_PINK.setTextColor("MI"));

	}


	public enum colorCharacter {
		RESET("\u001B[0m"), BLACK("\u001B[30m"), RED("\u001B[31m"), GREEN("\u001B[32m"), YELLOW("\u001B[33m"), BLUE("\u001B[34m"), PURPLE("\u001B[35m"), CYAN("\u001B[36m"), WHITE("\u001B[37m"), BLACK_BACKGROUND("\u001B[40m"), RED_BACKGROUND("\u001B[41m"), GREEN_BACKGROUND("\u001B[42m"), YELLOW_BACKGROUND("\u001B[43m"), BLUE_BACKGROUND("\u001B[44m"), WHITE_BACKGROUND("\u001B[47m"), TUNDRA_BACKGROUND("\u001b[48;5;166m"), BROWN_BACKGROUND("\u001b[48;5;136m"), BRIGHT_WHITE_BACKGROUND("\u001b[47;1m"), PLAIN_GREEN_BACKGROUND("\u001b[48;5;107m"), GRAY_BACKGROUND("\u001b[48;5;244m"), FOG_OF_WAR("\u001b[48;5;117m"), PURPLE_HIGH_INTENSITY("\033[0;95m"), WHITE_BOLD("\u001b[1m\u001b[38;5;255m"), BRIGHT_GREEN("\u001b[38;5;82m"), BRIGHT_WHITE("\u001b[38;5;255m"), BRIGHT_BLUE("\u001b[38;5;122m"), BRIGHT_MARSH_COLOR("\u001b[38;5;222m"), SHADED_BROWN_BACKGROUND("\u001b[48;5;95m"), BRIGHT_PINK("\u001b[38;5;225m");
