...
public enum Terrain {
	...
	GRASSLAND(2,0,0,-33,1,true,false,true,new Vector<ResourceType>(){{
		add(ResourceType.IRON);
	...
	HILLS(0,2,0,25,2,true,true,true,new Vector<ResourceType>(){{
		add(ResourceType.IRON);
		add(ResourceType.COAL);
	...
	MOUNTAIN(0,0,0,25,9999,false,true,false,new Vector<ResourceType>(){{
	}}),
	OCEAN(1,0,1,0,1,true,false,false,new Vector<ResourceType>(){{
	}}),
	PLAINS(1,1,0,-33,1,true,false,true,new Vector<ResourceType>(){{
		add(ResourceType.IRON);
		add(ResourceType.HORSES);
		add(ResourceType.COAL);
	...
	SNOW(0,0,0,-33,1,true,false,true,new Vector<ResourceType>(){{
		add(ResourceType.IRON);
	}}),
	TUNDRA(1,0,0,-33,1,true,false,true,new Vector<ResourceType>(){{
		add(ResourceType.IRON);
		add(ResourceType.HORSES);
		add(ResourceType.DEER);
		add(ResourceType.SILVER);
