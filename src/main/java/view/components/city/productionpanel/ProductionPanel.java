...
public class ProductionPanel extends TabPane {
    ...
    public ProductionPanel(City city) {
        BuildingType x = BuildingType.ARMORY;//just for compiling BuildingTypeEnum
        this.city = city;
        init();
    }
    ...
    private VBox newPaneContent(Vector<UnitType> units, Vector<BuildingType> buildings, boolean isProducing) {
        ...
        for (UnitType unitType : units) {
            ...
            vBox.getChildren().add(new ProductionRow(unitType,isProducing,cost));
        }
        ...
        for (BuildingType building : buildings) {
            ...
            vBox.getChildren().add(new ProductionRow(building,isProducing,cost));
        }
        return vBox;
    }
}
