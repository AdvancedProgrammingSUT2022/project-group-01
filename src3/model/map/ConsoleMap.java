...
public class ConsoleMap {
    ...
    private void initializeCharRepresent(){
        ...
        //Terrain Features
        charRepresentation.put(TerrainFeature.ICE, colorCharacter.WHITE.setTextColor("IC"));
        charRepresentation.put(TerrainFeature.FOREST, colorCharacter.WHITE.setTextColor("FO"));
        charRepresentation.put(TerrainFeature.JUNGLE, colorCharacter.WHITE.setTextColor("JU"));
        charRepresentation.put(TerrainFeature.MARSH, colorCharacter.WHITE.setTextColor("WH"));
        charRepresentation.put(TerrainFeature.OASIS, colorCharacter.WHITE.setTextColor("OA"));
        charRepresentation.put(TerrainFeature.RIVER, colorCharacter.WHITE.setTextColor("RI"));
        //Terrains
        ...
        charRepresentation.put(Terrain.TUNDRA, colorCharacter.TUNDRA_BACKGROUND.color);
        //Units
        ...
        charRepresentation.put(UnitType.LONG_SWORDSMAN, "lS" + colorCharacter.RESET.color);
